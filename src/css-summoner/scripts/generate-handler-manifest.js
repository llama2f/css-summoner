...
const handlersDir = path.resolve(projectRoot, 'src/css-summoner/templates/handlers/auto');
// 生成されるマニフェストファイルのパス
const manifestPath = path.resolve(projectRoot, 'src/css-summoner/configs/handler-manifest.json');
